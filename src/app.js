...
(function () {
  ...
  function renderResposta(r) {
    ...
    if (!r.viavel) {
      rotulo.textContent = 'Pode transferir no mês ' + nomeDoMes;
    ...
    // "Total planejado" sozinho, tres vezes maior que o destaque, se confunde
    // com a resposta da tela. O rotulo tem que dizer que ele NAO e' deste mes.
    var ultimaLinha = r.plano.linhas[r.plano.linhas.length - 1];
    var meses = horizonteValido();
    fato(fatos, 'Somando os próximos ' + meses + ' meses', E.formatarBRL(totalPlano),
